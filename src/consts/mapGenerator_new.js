...
export const testLevels = [
  {
    ...
    description:
      'Assessment: Novice. Niave. Typically raises pigeons and rats to fight. You can take them out.',
    options: [
      {
        id: '1a',
        shortDesc: 'Battle a Rookie Trainer',
        longDesc:
          'Assessment: Engage in your first test of strength against the welcoming Rookie Trainer, a crucial step on your journey. He might know how to get to the gym boss.',
        scene: 'BATTLE',
      },
    ],
    mapFeatures: ['Welcoming Arch', 'Symbolic Statues', 'Path of Trials'],
  },
  //Assessment: We're done with vermin. mostly.
  {
    id: 2,
